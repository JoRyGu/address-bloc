...
describe("ContactController", () => {
  ...
  describe("#addContact()", () => {
    it("should add a single contact into the book", done => {
      this.book
        .addContact("Alice", "001-101-1010", "alice@gmail.com")
        .then(contact => {
  ...
  describe("search methods", () => {
    ...
    describe("#iterativeSearch()", () => {
      it("should return null when called with an empty array", () => {
        expect(this.book.iterativeSearch([], "Alloy")).toBe(null);
      });
      ...
      it("should return null when contact is not found", done => {
        this.book
          .addContact(...zelda)
          .then(() => {
            expect(this.book.iterativeSearch(contacts, "Alloy Rodriguez")).toBe(
              null
            );
            done();
          })
